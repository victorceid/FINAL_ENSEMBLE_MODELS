...
```{r load-data, echo=TRUE, message=FALSE}
source("FINAL_ARIMA.r", local = TRUE, chdir = TRUE)
WIS_MAE=CLEAN_ARIMA(states_data,US_STATE=2,auto=FALSE, ES27=TRUE,my_n_ahead=1)
  #error<-data.frame(WIS_MAE$cases-expm1(WIS_MAE$predictions)) 

WIS_MAE
#plot(WIS_MAE$forecast_date,WIS_MAE$Number_of_models)
```
